      ...
      <section className="section-padding">
        <div className="container-custom max-w-3xl">
          <SectionHeader
            ...
            description="Upload required files for faster admission support."
          />

          <div className="flex items-start gap-3 bg-accent/10 rounded-xl p-4 mb-8">
            <AlertTriangle className="w-5 h-5 text-accent shrink-0 mt-0.5" />
            <div>
              <p className="text-sm font-medium text-foreground">Upload backend is active.</p>
              <p className="text-sm text-muted-foreground">
                If your submission fails, please contact DGEC by WhatsApp or email for urgent document submissions.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 mb-12">
            {[
              ...
              <div key={s.num} className="text-center">
                <div className="w-10 h-10 rounded-full bg-accent text-accent-foreground font-display font-bold flex items-center justify-center mx-auto mb-2">
                  {s.num}
                </div>
            ...
            <div>
              ...
              >
                ...
                <p className="text-xs text-muted-foreground mb-4">
                  Accepted: PDF, JPG, JPEG, PNG, DOC, DOCX, ZIP (max 10MB each)
                </p>
                <input
                  type="file"
                  id="fileUpload"
          ...
          <div className="mt-12 bg-card rounded-xl p-6 shadow-card text-center">
            ...
            <p className="text-muted-foreground text-sm mb-4">
              Contact our team for assistance with document submission.
            </p>
